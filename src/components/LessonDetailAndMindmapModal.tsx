        ...
        <div className="flex-1 overflow-y-auto p-5 space-y-4">
          ...
          {activeModalTab === 'review' && record && (
            <div className="bg-purple-50/60 dark:bg-purple-950/40 border border-purple-200 dark:border-purple-800/80 p-5 rounded-3xl space-y-3">
              ...
              {currentRole === 'admin' && (
                <div className="p-3 bg-purple-100/60 dark:bg-purple-900/30 rounded-2xl text-xs text-purple-900 dark:text-purple-200 flex items-center gap-2">
                  <Sparkles className="w-4 h-4 text-purple-600 shrink-0" />
                  <span>Chế độ Chỉ đọc (Read-Only) giúp Phụ huynh theo dõi và động viên quá trình tự học của con an toàn.</span>
                </div>
              )}
            </div>
          )}
